...
import com.xinzodl.code.codeward.CW9_RainTest._
import org.scalatest._

// https://www.codewars.com/kata/56a32dd6e4f4748cc3000006
class CW9_RainTest extends FlatSpec with Matchers {
  "Rain.mean" should "pass fixed tests with data" in {
    CW9_Rain.mean("London", data) should equal (51.199999999999996 +- 1e-2)
  }

  "Rain.variance" should "pass fixed tests with data" in {
    CW9_Rain.variance("London", data) should equal (57.42833333333374 +- 1e-2)
  }
}
